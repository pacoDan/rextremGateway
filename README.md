...
└── README.md
```
# Detener y Limpiar Contenedores Docker

Este comando de Docker Compose detendrá y eliminará todos los contenedores, imágenes y volúmenes relacionados con tu proyecto.
...
```
- Detendrá todos los contenedores relacionados con tu proyecto.
- Eliminará las imágenes de Docker creadas localmente.
- Eliminará los volúmenes de Docker asociados.
- Eliminará los contenedores huérfanos que no están definidos en tu archivo docker-compose.yml.

# Correr y Ejecutar Contenedores Docker
...
services:
  ...
  mongo:
    ...
    ...
```
The compose file defines an application with three services `frontend-portal`, `backend` and `db`.
